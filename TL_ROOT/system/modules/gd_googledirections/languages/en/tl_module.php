...
$GLOBALS['TL_LANG']['tl_module']['gd_googledirections_marker_coords']= array('Coordinates of the marker', 'The coordinates of the marker can differ from the map center. This field must be filled in order to show the marker.');
